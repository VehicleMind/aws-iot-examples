...
HardwareSerial mySerial(1); // UART Number connected to modem
/*
   Hardware Serial through which ESP32 talks to the modem
*/
extern String MQTT_HOST;
extern String MQTT_PORT;
extern String CELL_APN;
extern String CELL_USR;
extern String CELL_PWD;
...
{
  Serial.begin(115200); // this is the USB Serial for logging
  mySerial.begin(115200); // this is the hardware serial connection to modem
  mySerial.write("AT\r\n");
  delay(1000);
  _tcpInit();
}
