//---------------------------------------------------
//INCLUDE GUARD
#ifndef MQTT_PACKET_H_INCLUDED
#define MQTT_PACKET_H_INCLUDED
...
public:
   ...
   */
  static lwmqtt_err_t lwmqtt_detect_packet_type(uint8_t *buf, size_t buf_len, lwmqtt_packet_type_t *packet_type);
   ...
   * @return An error value.
   */
  static lwmqtt_err_t lwmqtt_detect_remaining_length(uint8_t *buf, size_t buf_len, uint32_t *rem_len);
  ...
  /**
    ...
    * @return An error value.
    */
  static lwmqtt_err_t lwmqtt_encode_connect(uint8_t *buf, size_t buf_len, size_t *len, lwmqtt_options_t options,
                                     lwmqtt_will_t *will);
  ...
  /**
    ...
    * @return An error value.
    */
  static lwmqtt_err_t lwmqtt_decode_connack(uint8_t *buf, size_t buf_len, bool *session_present,
  ...
  /**
    ...
    * @return An error value.
    */
  static lwmqtt_err_t lwmqtt_encode_zero(uint8_t *buf, size_t buf_len, size_t *len, lwmqtt_packet_type_t packet_type);
  ...
  /**
    ...
    * @return An error value.
    */
  static lwmqtt_err_t lwmqtt_decode_ack(uint8_t *buf, size_t buf_len, lwmqtt_packet_type_t packet_type, bool *dup,
                                 uint16_t *packet_id);
  ...
  /**
    ...
    * @return An error value.
    */
  static lwmqtt_err_t lwmqtt_encode_ack(uint8_t *buf, size_t buf_len, size_t *len, lwmqtt_packet_type_t packet_type, bool dup,
                                 uint16_t packet_id);
  ...
  /**
    ...
    * @return An error value.
    */
  static lwmqtt_err_t lwmqtt_decode_publish(uint8_t *buf, size_t buf_len, bool *dup, uint16_t *packet_id, lwmqtt_string_t *topic,
  ...
  /**
    ...
    * @return An error value.
    */
  static lwmqtt_err_t lwmqtt_encode_publish(uint8_t *buf, size_t buf_len, size_t *len, bool dup, uint16_t packet_id,
  ...
  /**
    ...
    * @return An error value.
    */
  static lwmqtt_err_t lwmqtt_encode_subscribe(uint8_t *buf, size_t buf_len, size_t *len, uint16_t packet_id, int count,
  ...
  /**
    ...
    * @return An error value.
    */
  static lwmqtt_err_t lwmqtt_decode_suback(uint8_t *buf, size_t buf_len, uint16_t *packet_id, int max_count, int *count,
  ...
  /**
    ...
    * @return An error value.
    */
  static lwmqtt_err_t lwmqtt_encode_unsubscribe(uint8_t *buf, size_t buf_len, size_t *len, uint16_t packet_id, int count,
