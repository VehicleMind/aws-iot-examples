//---------------------------------------------------
//INCLUDE GUARD
#ifndef MQTT_HELPERS_H_INCLUDED
#define MQTT_HELPERS_H_INCLUDED

//---------------------------------------------------
//INCLUDE DEPS
#include "mqtt_string_helpers.h"
...
class Helpers
{
   ...
   */
  static uint8_t lwmqtt_read_bits(uint8_t byte, int pos, int num);
   ...
   */
  static void lwmqtt_write_bits(uint8_t *byte, uint8_t value, int pos, int num);
   ...
   */
  static lwmqtt_err_t lwmqtt_read_data(uint8_t **buf, const uint8_t *buf_end, uint8_t **data, size_t len);
   ...
   * @return LWMQTT_SUCCESS or LWMQTT_BUFFER_TOO_SHORT.
   */
  static lwmqtt_err_t lwmqtt_write_data(uint8_t **buf, const uint8_t *buf_end, uint8_t *data, size_t len);
   ...
   * @return LWMQTT_SUCCESS or LWMQTT_BUFFER_TOO_SHORT.
   */
  static lwmqtt_err_t lwmqtt_read_num(uint8_t **buf, const uint8_t *buf_end, uint16_t *num);
   ...
   * @return LWMQTT_SUCCESS or LWMQTT_BUFFER_TOO_SHORT.
   */
  static lwmqtt_err_t lwmqtt_write_num(uint8_t **buf, const uint8_t *buf_end, uint16_t num);
   ...
   * @return LWMQTT_SUCCESS or LWMQTT_BUFFER_TOO_SHORT.
   */
  static lwmqtt_err_t lwmqtt_read_string(uint8_t **buf, const uint8_t *buf_end, lwmqtt_string_t *str);
   ...
   * @return LWMQTT_SUCCESS or LWMQTT_BUFFER_TOO_SHORT.
   */
  static lwmqtt_err_t lwmqtt_write_string(uint8_t **buf, const uint8_t *buf_end, lwmqtt_string_t str);
   ...
   * @return LWMQTT_SUCCESS or LWMQTT_BUFFER_TOO_SHORT.
   */
  static lwmqtt_err_t lwmqtt_read_byte(uint8_t **buf, const uint8_t *buf_end, uint8_t *byte);
   ...
   * @return LWMQTT_SUCCESS or LWMQTT_BUFFER_TOO_SHORT.
   */
  static lwmqtt_err_t lwmqtt_write_byte(uint8_t **buf, const uint8_t *buf_end, uint8_t byte);
   ...
   */
  static lwmqtt_err_t lwmqtt_varnum_length(uint32_t varnum, int *len);
   ...
   */
  static lwmqtt_err_t lwmqtt_read_varnum(uint8_t **buf, const uint8_t *buf_end, uint32_t *varnum);
   ...
   * @return LWMQTT_SUCCESS, LWMQTT_BUFFER_TOO_SHORT or LWMQTT_VARNUM_OVERFLOW.
   */
  static lwmqtt_err_t lwmqtt_write_varnum(uint8_t **buf, const uint8_t *buf_end, uint32_t varnum);
};
