...
public:
  ...
  virtual bool read(float* acc = 0, float* gyr = 0, float* mag = 0, int16_t* temp = 0, ORIENTATION* ori = 0);
protected:
  bool initI2C();
  void uninitI2C();
  void getAres();
...
public:
  ...
  bool read(float* acc = 0, float* gyr = 0, float* mag = 0, int16_t* temp = 0, ORIENTATION* ori = 0);
private:
  void getMres();
  void getGres();
  ...
  void magcalMPU9250(float * magBias, float * magScale);
